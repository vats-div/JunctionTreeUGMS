...
%%
   fprintf('\n*****************************************************')
   fprintf('*****************')
   fprintf('\n  Newton-CG Primal Proximal-Point Algorithm')
...
%%
   ...
   fprintf('\n CPU time      = %3.2f',sum(runhist.cputime)); 
   ...
   %%fprintf('\n average rank   of SDP block                 = %3.2f',...
